...
public class CholeskyFactorization {
	...
	private static Log log = LogFactory.getLog(CholeskyFactorization.class.getName());
	
	public CholeskyFactorization(DoubleMatrix2D Q) throws JOptimizerException{
	 ...
	 */
	public CholeskyFactorization(DoubleMatrix2D Q, MatrixRescaler rescaler) throws JOptimizerException{
		this.dim = Q.rows();
		this.Q = Q;
