...
public class CholeskyRCTFactorization {
	...
	private static Log log = LogFactory.getLog(CholeskyRCTFactorization.class.getName());
	
	public CholeskyRCTFactorization(DoubleMatrix2D Q) throws JOptimizerException{
		this.dim = Q.rows();
		this.Q = Q;
	}
