...
public class CholeskyUpperDiagonalFactorization {
	...
	public CholeskyUpperDiagonalFactorization(SparseDoubleMatrix2D Q, int diagonalLength) throws JOptimizerException{
	 ...
	 */
	public CholeskyUpperDiagonalFactorization(SparseDoubleMatrix2D Q, int diagonalLength, MatrixRescaler rescaler) throws JOptimizerException{
		this.dim = Q.rows();
		this.Q = Q;
		if(diagonalLength < 0){
