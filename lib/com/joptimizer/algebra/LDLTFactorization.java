...
public class LDLTFactorization {
	...
	private static Log log = LogFactory.getLog(LDLTFactorization.class.getName());

	public LDLTFactorization(DoubleMatrix2D Q) throws JOptimizerException {
		this(Q, null);
	}
	
	public LDLTFactorization(DoubleMatrix2D Q, MatrixRescaler rescaler) throws JOptimizerException {
		this.dim = Q.rows();
		this.Q = Q;
	...
	public DoubleMatrix1D solve(DoubleMatrix1D b) {
		...
		// log.debug("L.y: " + ArrayUtils.toString(getL().operate(y)));
