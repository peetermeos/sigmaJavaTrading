...
public class QRSparseFactorization {
	...
	public QRSparseFactorization(SparseDoubleMatrix2D A) throws JOptimizerException {
		this(A, 0, null);
	}
	
	public QRSparseFactorization(SparseDoubleMatrix2D A, int order) throws JOptimizerException {
		this(A, order, null);
	}
	
	public QRSparseFactorization(SparseDoubleMatrix2D A, MatrixRescaler rescaler) throws JOptimizerException {
		this(A, 0, rescaler);
	}
	 ...
	 */
	public QRSparseFactorization(SparseDoubleMatrix2D A, int order, MatrixRescaler rescaler) throws JOptimizerException {
		if (order < 0 || order > 3) {
