...
public class OptimizationRequest {
	...
	/**
	 * Should objectvive function coefficients normalization be disabled?
	 */
	private boolean objectiveFunctionNormalizationDisabled = false;
	...
	public boolean isObjectiveFunctionNormalizationDisabled() {
		return objectiveFunctionNormalizationDisabled;
	}

	public void setObjectiveFunctionNormalizationDisabled(boolean objectiveFunctionNormalizationDisabled) {
		this.objectiveFunctionNormalizationDisabled = objectiveFunctionNormalizationDisabled;
	}
}
